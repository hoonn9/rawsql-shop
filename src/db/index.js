  ...
  conn.query(
    `
        ...
        (
            ...
            info_gender      ENUM('male', 'female')           NULL        COMMENT '제품 성별', 
  ...
  conn.query(
    `
        ...
        (
            ...
            rent_state  ENUM('LOW', 'MIDDLE', 'HIGH')    NULL        COMMENT '대여 상태', 
  ...
  conn.query(
    `
        ...
        (
            ...
            post_type  ENUM('BEST', 'WEEKLY')           NULL        COMMENT '포스터 유형', 
...
//               REFERENCES TB_Products (info_id)
//         `,
//     (err, results) => {
//       if (err) throw err;
//       console.log(results);
